...
function FilterBills1(range) {
    ...
    $.ajax({
        "async": true,
        "crossDomain": true,
        "url": DomainAPI + "Provider/GetBillsByTypeDateTime?from=" + from + "&to=" + to + "&providerId=" + providerId + "&start=" + range + "&end=10&type=2",
        "method": "GET",
        "headers": {
...
function downloadcsvl() {
    ...
    $.ajax({
        url: DomainAPI + "Provider/GetCsvBillsFile?providerId=" + providerId + "&from=" + from + "&to=" + to + "&type=2&noteName="+ notetype,
        method: 'GET',
        headers: {
            "Authorization": Token
        },
...
function downloadexcel() {
	...
	var notetype =  sessionStorage.getItem('notsas');
    $.ajax({
       url: DomainAPI + "Provider/GetExcelBillsFile?providerId=" + providerId + "&from=" + from + "&to=" + to + "&type=2&noteName="+ notetype,
        method: 'GET',
        headers: {
         "Authorization": Token
