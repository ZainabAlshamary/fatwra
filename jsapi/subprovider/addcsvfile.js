...
function uploadcsv() {
    ...
    if (extension === 'CSV') {
        ...
        $.ajax({
            url: DomainAPI + 'SubProvider/UploadBillsCSV?' + other_data, // 
            headers: {
    ...
    $(".loading").fadeOut();
        ...
        form_data.append('file', file_data);
        $.ajax({
            url: DomainAPI + 'SubProvider/UploadBillsExcel?serviceId=' + serviceId + '&excelType=' + xType + '', // 
            headers: {
...
function GetInformation() {
    ...
    $.ajax({
        "async": true,
        "crossDomain": true,
        "url": DomainAPI + "SubProvider/GetProviderInformation",
        "method": "GET",
        "headers": {
            "Authorization": Token
        },
...
function APIilex(filetype) {
    ...
    $.ajax({
        url: DomainAPI + "SubProvider/GetExcelTemplateFile?excelFileType=" + filetype + "&noteName=" + notetype ,
        method: 'GET',
        headers: {
            "Authorization": Token
        },
...
function APIilecsv(filetype) {
    ...
    var notetype =  sessionStorage.getItem('notsas');
    $.ajax({
        url: DomainAPI + "SubProvider/GetCsvTemplateFile?csvFileType=" + filetype + "&noteName=" + notetype ,
        method: 'GET',
        headers: {
            "Authorization": Token
        },
