...
function GetData() {
    ...
    $.ajax({
        "async": true,
        "crossDomain": true,
        "url": DomainAPI + "SubProvider/GetAllBills?start=" + RangePages + "&end=10",
        "method": "GET",
        "headers": {
            "Authorization": Token
        },
...
function cancelbill(payid) {
    ...
    swal({
        ...
        $.ajax({
            url: DomainAPI + 'SubProvider/CancelBill', // 
            headers: {
...
function paybill(ida) {
    ...
    swal({
        ...
        $.ajax({
            url: DomainAPI + 'SubProvider/PayBill?payId=' + billid, // 
            headers: {
...
function editbilldate(payId) {
    ...
    $.ajax({
        "async": true,
        "crossDomain": true,
        "url": DomainAPI + "SubProvider/UpdateLateBillDueDate?billId=" + billId + "&newDueDate=" + newDueDate,
        "method": "POST",
        "headers": {
            "Content-Type": "application/json",
            "Authorization": Token
...
function ShowWithoutFourm(id) {
 ...
 <div class="col-md-2 text-center">
                        <img src="` + ItemInformation.data.imagePath + `" id="logoimg" width="100" height="100" style="margin-top: -100px;">
