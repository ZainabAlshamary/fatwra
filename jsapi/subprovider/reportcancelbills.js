...
function GetDataByStartEnd() {
    ...
    $.ajax({
        "async": true,
        "crossDomain": true,
        "url": DomainAPI + "SubProvider/GetBillsByType?start=" + RangePages + "&end=10&type=4",
        "method": "GET",
        "headers": {
...
function FilterBills1(range) {
    ...
    $.ajax({
        "async": true,
        "crossDomain": true,
        "url": DomainAPI + "SubProvider/GetBillsByTypeDateTime?from=" + from + "&to=" + to + "&start=" + range + "&end=10&type=3",
        "method": "GET",
        "headers": {
...
function downloadcsvl() {
    ...
    $.ajax({
        url: DomainAPI + "SubProvider/GetCsvBillsFile?from=" + from + "&to=" + to + "&type=3&noteName="+ notetype,
        method: 'GET',
        headers: {
            "Authorization": Token
        },
...
function downloadexcel() {
	...
	var notetype =  sessionStorage.getItem('notsas');
    $.ajax({
       url: DomainAPI + "SubProvider/GetExcelBillsFile?providerId=" + providerId + "&from=" + from + "&to=" + to + "&type=3&noteName="+ notetype,
        method: 'GET',
        headers: {
         "Authorization": Token
