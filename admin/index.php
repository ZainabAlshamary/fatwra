...
<script src="../jsapi/admin/dashboard.js"></script>
								...
								<div class="item">
									<div class="card custom-card">
										<div class="card-body">
											<div class="d-flex no-block align-items-center">
												<div>
													<span class="text-muted tx-13 mb-3">عدد الفواتير الغير مدفوعة</span>
						...
						<!-- row opened -->
							...
							<div class="col-md-12 col-sm-12 col-lg-12  col-xl-12 col-xxl-12">
								<div class="card custom-card overflow-hidden">
									<div class="card-header border-bottom-0">
										<label class="main-content-label my-auto pt-2">افضل خمسة مزودين</label>
										<span class="d-block tx-12 mb-4 mt-1 text-muted">عرض افضل خمسة مزودين من ناحية الفواتير المصدر</span>
									</div>
									<ul class="crypto-transcation list-unstyled mg-b-0" id="topprovider">
