...
<script src="../jsapi/provider/dashboard.js?version=<?= time() ?>"></script>
				...
				<div class="container-fluid">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">اهلا بكم في نظام فاتورة</h2>
								<ol class="breadcrumb">
							...
							<div class="col-md-12 col-sm-12 col-lg-12 col-xl-12 col-xxl-12">
								<div class="card custom-card">
									<div class="card-header border-bottom-0">
										...
										<span class="d-block tx-12 mb-0 mt-1 text-muted">يصنف حسب طرق الدفع</span>
									</div>
						...
						<!-- row opened -->
							...
							<div class="col-md-6 col-sm-12 col-lg-6  col-xl-6 col-xxl-6">
								<div class="card custom-card overflow-hidden">
									<div class="card-header border-bottom-0">
										<label class="main-content-label my-auto pt-2">افضل الفروع</label>
										<span class="d-block tx-12 mb-4 mt-1 text-muted">عرض افضل الفروع من ناحية عدد الفواتير</span>
									</div>
									<ul class="crypto-transcation list-unstyled mg-b-0" id="topsubprovider">
