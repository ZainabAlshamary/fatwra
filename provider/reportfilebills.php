...
<script src="../jsapi/provider/reportfilebills.js"></script>
							...
							<div class="col-lg-12 col-md-12">
								<div class="card custom-card">
									<div class="card-body">
										...
										<button class="btn ripple btn-primary" style="margin-top: 28px;width: 100%;" onclick="GetFileBillsByDateTime(0)" >بحث</button>
										</div>
										</div>
										</div>
									</div>
