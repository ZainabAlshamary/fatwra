...
<script src="../jsapi/subprovider/addcancelfile.js"></script>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                        <div class="alert alert-success" role="alert" style="">
                                                            ...
                                                            <button type="button" onclick="APIile('cancelFile.xlsx')" class="btn ripple btn-primary" style="font-size: 10px;
														position: relative;
														float: left;
