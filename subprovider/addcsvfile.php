...
<script src="../jsapi/subprovider/addcsvfile.js"></script>
  ...
  <div class="page-header">
							<div>
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">ان شاء مجموعة فواتير</li>
								</ol>
							</div>
						</div> 
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-4">
                                                    <div class="alert alert-success" role="alert" style="">
                                                        ...
                                                        <button type="button" onclick="APIilecsv('1')" class="btn ripple btn-primary" style="font-size: 10px;
    position: relative;
    float: left;
    top: -10px;left: 15px;    ">تحميل  <i class="fa fa-download" aria-hidden="true"></i></button>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-4 col-md-4">
                                                    <div class="alert alert-success" role="alert" style="">
                                                        ...
                                                        <button type="button" onclick="APIilecsv('2')" class="btn ripple btn-primary" style="font-size: 10px;
    position: relative;
    float: left;
    top: -10px;left: 15px;">تحميل  <i class="fa fa-download" aria-hidden="true"></i></button>
                                                    </div>
                                                ...
                                                <div class="col-lg-4 col-md-4">
                                                    <div class="alert alert-success" role="alert" style="">
                                                        ...
                                                        <button type="button" onclick="APIilex('1')" class="btn ripple btn-primary" style="font-size: 10px;
    position: relative;
    float: left;
    top: -10px;left: 15px;">تحميل  <i class="fa fa-download" aria-hidden="true"></i></button>
                                                    </div>
                                                ...
                                                <div class="col-lg-4 col-md-4">
                                                    <div class="alert alert-success" role="alert" style="">
                                                        ...
                                                        <button type="button" onclick="APIilex('2')" class="btn ripple btn-primary" style="font-size: 10px;
    position: relative;
    float: left;
    top: -10px;left: 15px;">تحميل  <i class="fa fa-download" aria-hidden="true"></i></button>
                                                    </div>
