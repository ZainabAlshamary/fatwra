...
<script src="../jsapi/subprovider/createbill.js"></script>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 ">
											...
											<div class="col-md-8 ">
                                                    <div class="col-md-7">
                                                        <label style="font-size: 17px;font-weight: bold;color: #6259ca;">اسم الشركة :</label>
                                                        <label style="font-size: 17px;font-weight: bold;color: #6259ca" id="companyName"></label>
                                                    </div>
                                                    <div class="col-md-7">
                                                        <label style="font-size: 17px;font-weight: bold;color: #6259ca;">رقم الهاتف :</label>
                                                        <label style="font-size: 17px;font-weight: bold;color: #6259ca;" id="phoneNumber"></label>
                                                    </div>
                                                    <div class="col-md-7">
                                                        <label style="font-size: 17px;font-weight: bold;color: #6259ca;">العنوان :</label>
                                                        <label style="font-size: 17px;font-weight: bold;color: #6259ca;" id="address"></label>
                                                    </div>
                                                    <div class="col-md-7">
                                                        <label style="font-size: 17px;font-weight: bold;color: #6259ca;">البريد الالكتروني :</label>
                                                        <label style="font-size: 17px;font-weight: bold; color: #6259ca;" id="email"></label>
                                                    </div>
                                             ...
                                             <div class="row"  style="margin-bottom: 21px;">
                                                <div class="col-lg-4 col-md-6">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text" style="color: #fff !important;background-color: #6259ca !important;" id="basic-addon1">YY/MM/DD</span>
                                                    </div>
											   ...
											   <div class="col-lg-4 col-md-6">
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text" style="color: #fff !important;background-color: #6259ca !important;" id="basic-addon1">IQD</span>
                                                    </div>
