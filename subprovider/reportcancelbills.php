...
<script src="../jsapi/subprovider/reportcancelbills.js"></script>
						...
						<div class="page-header">
							<div>
								...
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">الفواتير الملغاة</li>
								</ol>
							</div>
						</div> 
						<!-- End Page Header -->
                                                        ...
                                                        <td colspan="100%" class="justify-content-center">
                                                                <nav aria-label="...">
                                                                        <ul class="pagination justify-content-center">
                                                                            <li id="Previous" onclick="Pagension(-1)" style="cursor: pointer;" style="cursor: pointer;" class="page-item disabled">
